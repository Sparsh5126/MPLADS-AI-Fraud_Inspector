...
const reports = [
  { id: 'RPT-D001', title: 'Monthly Work Status Report – Jun 2025', category: 'Progress', date: '01 Jul 2025', size: '1.4 MB', format: 'PDF' },
  { id: 'RPT-D002', title: 'Anomaly Detection Summary – Q2 2025', category: 'Risk Analysis', date: '15 Jun 2025', size: '0.9 MB', format: 'PDF' },
  { id: 'RPT-D003', title: 'Fund Utilisation Report – May 2025', category: 'Finance', date: '05 Jun 2025', size: '0.7 MB', format: 'Excel' },
  { id: 'RPT-D004', title: 'Implementing Agency Performance', category: 'Agency', date: '22 May 2025', size: '1.1 MB', format: 'PDF' },
  { id: 'RPT-D005', title: 'Delayed Works Detail Report', category: 'Progress', date: '10 May 2025', size: '0.6 MB', format: 'Excel' },
  { id: 'RPT-D006', title: 'Payment Disbursement Summary – Apr 2025', category: 'Finance', date: '02 May 2025', size: '0.8 MB', format: 'PDF' },
];
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Generated reports for Meerut district</p>
        </div>
