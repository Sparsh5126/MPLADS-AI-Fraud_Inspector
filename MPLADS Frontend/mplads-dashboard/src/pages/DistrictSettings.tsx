          ...
          {active === 'profile' && (
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[['Full Name', 'District Collector, Meerut'], ['Designation', 'District Authority'], ['District', 'Meerut'], ['State', 'Uttar Pradesh'], ['Email', 'collector.meerut@up.gov.in'], ['Mobile', '+91 98765 43210']].map(([label, val]) => (
                  <div key={label}>
